...
const Loading = () => {
  return (
    <div className="min-h-44 w-full flex shadow-md m-1 rounded-md p-3 sm:w-2/5 md:flex-col md:w-[30%] md:min-h-[250px] gap-3 group hover:opacity-95 active:opacity-100 bg-white animate-pulse">
